...
class GraphScene(Scene):
    ...
    def setup_axes(self, animate=False, hideaxes=False):
        ...
        x_axis = NumberLine(
            ...
            decimal_number_config={"num_decimal_places": self.x_label_decimals},
        )
    ...
    def get_horizontal_line_to_graph(
        self,
        x, graph,
        line_class=Line,
        **line_kwargs
        ...
        """
        This method returns a Horizontal line from the y-axis to 
        the corresponding point on the graph/curve.

        Parameters
        ----------
        y Union[int,float]
            The y-value at which the line should be placed/calculated.
