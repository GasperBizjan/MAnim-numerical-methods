...
class Shapes(Scene):
    ...
    def construct(self):
        circle = Circle()
        square = Square()
        line = Line(np.array([3, 0, 1]), np.array([5, 0, 0]))
...
class MoreShapes(Scene):
    # python -m manim pymanim_tutorial_P37.py MoreShapes -pl
...
class AddingMoreText(Scene):
    # python -m manim pymanim_tutorial_P37.py AddingMoreText -pl
...
class RotateAndHighlight(Scene):
    # python -m manim pymanim_tutorial_P37.py RotateAndHighlight -pl
...
class BasicEquations(Scene):
    # python -m manim pymanim_tutorial_P37.py BasicEquations -pl
...
# python -m manim pymanim_tutorial_P37.py PlotFunctions -pl
    CONFIG = {
        "x_min": -10,
        "x_max": 10.3,
        "y_min": -1.5,
