...
from from_3b1b.active_projects.diffyq.part2.shared_constructs import *
#python -m manim heat_equation.py TwoDBodyWithManyTemperatures -pl
...
class BringTwoRodsTogether(Scene):
    # python -m manim heat_equation.py BringTwoRodsTogether -pl
    CONFIG = {
        "step_size": 0.05,
        "axes_config": {
            "x_min": -1,
...
class DiscreteSetup(ShowEvolvingTempGraphWithArrows):
    # python -m manim heat_equation.py DiscreteSetup -pl
    CONFIG = {
        "step_size": 1,
...
class ShowManyVLines(TransitionToContinuousCase):
    #python -m manim heat_equation.py ShowManyVLines -pl
    CONFIG = {
        "wait_time": 20,
        "max_denom": 10,
        "x_step": 0.025,
...
class ShowNewtonsLawGraph(Scene):
    #python -m manim heat_equation.py ShowNewtonsLawGraph -pl
    CONFIG = {
        "k": 0.2,
